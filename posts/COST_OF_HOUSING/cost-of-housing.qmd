...
This period has seen substantial growth. From January 2012 to `r tb_final01$date %>% last() %>% format("%B %Y")`, the real median household income grew to `r dollar(p3_ri_2)` representing an annual growth of `r round((((p3_ri_2/p2_ri_2) - 1)/getDif(as.Date("2012-01-01"), tb_final01$date %>% last()) * 100), 2)` pp per year. NEED COMMENTARY ON HOW THIS GROWTH RELATES TO AVERAGE GROWTH IN HOUSING COST. NEED DETAILS ON ECONOMIC CONDITION.
